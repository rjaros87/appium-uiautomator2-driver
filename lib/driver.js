...
class AndroidUiautomator2Driver extends BaseDriver {
  ...
  async setAllowInvisibleElements (allowInvisible) {
    await this.uiautomator2.jwproxy.command('/appium/device/allowInvisibleElements', 'POST', {allowInvisibleElements: allowInvisible});
  }
  ...
  async onSettingsUpdate (key, value) {
    ...
    if (key === "allowInvisibleElements") {
      await this.setAllowInvisibleElements(value);
    }
  }
